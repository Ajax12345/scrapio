...
if __name__ == '__main__':
    ...
    _full_tree, stylesheet = tree_merger.StyleTree.merge_trees(soup(open('test_input_5.html').read(), 'html.parser'), soup(open('test_input_4.html').read(), 'html.parser')), style_parser._StyleSheet.load_test()
